<template>
  <Page auto-content-height>
    <div class="wms-customer-page">
      <!-- Page Header -->
      <div class="page-header">
        <div class="header-left">
          <h1 class="page-title">WMS0040 客户管理</h1>
          <p class="page-desc">管理客户基本信息、联系方式等</p>
        </div>
          ...
          <div class="filter-tags-wrap">
            ...
            >
              ...
              <Input
                ...
                v-model:value="queryForm[field.key as keyof CustomerQuery]"
                allow-clear
...
const STORAGE_KEY = 'customer_filter_fields';
...
const allFieldDefs: FilterFieldDef[] = [
  { key: 'customerCode', label: '客户编码', type: 'input' },
  { key: 'customerName', label: '客户名称', type: 'input' },
  { key: 'contactPerson', label: '联系人', type: 'input' },
  { key: 'contactPhone', label: '联系电话', type: 'input' },
  { key: 'mobile', label: '手机', type: 'input' },
];
...
function loadFilterFields() {
  try {
    ...
    if (saved) {
      ...
      // Default: show customerCode and customerName
