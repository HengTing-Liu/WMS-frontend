    ...
    <div class="p-4">
      ...
      <Card class="mb-4">
        <WmsSearchBar
          ...
          cache-key="wms-material-fields-cache"
          @search="handleSearch"
          @reset="handleReset"
        />
      </Card>
...
import { Button, Switch, Popconfirm, Card, Tag, Tooltip } from 'ant-design-vue';
...
import MaterialModal from '../../sys/material/components/material-modal.vue';
...
// 远程字段接口 URL
const remoteFieldsUrl = '/api/system/meta/column/schema?tableCode=wms_material';
